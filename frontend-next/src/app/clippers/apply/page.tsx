    ...
    <section className="relative min-h-[80vh] overflow-hidden pt-32 pb-16 px-6">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <motion.form
          ...
          onSubmit={(e) => {
            e.preventDefault();
            // Tomorrow: POST to /api/v1/clippers/apply
            setSubmitted(true);
          }}
        ...
        >
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button
              type="submit"
              className="px-7 py-3 bg-[color:var(--color-accent-tertiary)] text-[color:var(--color-bg-base)] font-semibold rounded-full shadow-[0_0_24px_var(--color-glow-violet)] hover:scale-[1.02] transition-transform"
            >
              Submit application →
            </button>
          </div>
